...
function findBestResponse(userMessage) {
    ...
    if (message.includes('電話')) {
        return "申し訳ございませんが、電話での相談は行っておりません。チャットでのやり取りのみとなります。税務に関するご質問はこちらのチャットでお気軽にどうぞ！";
    }
    if (message.includes('相談') || message.includes('聞きたい')) {
        return "どのようなことでもお気軽にご相談ください。税務のプロが分かりやすくお答えいたします。具体的にどのようなことでお困りでしょうか？※電話での相談は行っておりません。チャットでのみ承っております。";
    }
